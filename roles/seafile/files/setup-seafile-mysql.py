...
class AbstractDBConfigurator(AbstractConfigurator):
    ...
    def __init__(self):
        ...
        self.seafile_mysql_user = 'seafile'
        self.seafile_mysql_password = 'seafilepwd'
...
'''
        return 2 #Utils.ask_question(question,
                 #                key='1 or 2',
                 #                note=note,
                 #                validate=validate)
...
class ExistingDBConfigurator(AbstractDBConfigurator):
    ...
    def ask_questions(self):
        ...
        self.ccnet_db_name = 'ccnet-db' #self.ask_db_name('ccnet')
        self.seafile_db_name = 'seafile-db' #self.ask_db_name('seafile')
        self.seahub_db_name = 'seahub-db' #self.ask_db_name('seahub')
